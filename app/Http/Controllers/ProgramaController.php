...
class ProgramaController extends Controller
{
    ...
    public function create()
    {
        ...
        $modalidadejecucion= Modalidadejecucion::pluck('nombre','id');
        $tipoprograma = Tipoprograma::pluck('nombre','id');
        return view('programa.create', compact('programa','modalidadejecucion','tipoprograma'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('programa.edit', compact('programa','modalidadejecucion','tipoprograma'));
    }
